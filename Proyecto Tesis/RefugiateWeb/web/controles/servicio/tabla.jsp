                ...
                <tbody>
                 ...
                 %>
                  <tr >
                    ...
                    <td class="center">
                         <center> <a href="javascript:void(0)" onclick="edit_form(<%=entidad.getIdServicio()%>,'<%=entidad.getNombre()%>',<%=entidad.getEstado()%>)" class="btn btn-primary btn-sm btn-small">Editar</a></center> 
                    </td>
                  </tr>
                <%}%> 
                </tbody>
