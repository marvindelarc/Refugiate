        ...
        <!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
            ...
            <div class="content">
                ...
                <div class="page-title"> 
                    ...
                    <h3>Configuraci&oacute;n - <span class="semi-bold">Tipo de paquetes</span></h3>
                </div>	  
                <div class="row-fluid">
                    <div class="span12">
                        <div class="grid simple">
                            <div class="grid-title no-border">
                                <h4>Datos del <span class="semi-bold">Paquete</span></h4>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span4">
                                            <div class="control-group">
                                                ...
                                                <span class="help">Ingresar monto.</span>
                                        ...
                                        <div class="span4">
                                            <div class="control-group">
                                                ...
                                                <span class="help">Ingresar cantidad de meses.</span>
                                                <div class="input-with-icon  right">                                       
                                                    <i class=""></i>
