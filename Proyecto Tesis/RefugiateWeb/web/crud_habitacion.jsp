        ...
        <div id="container" class="page-content">
            ...
            <div class="content">
                ...
                <div class="page-title"> <i class="icon-custom-left"></i>
                    <h3>Configuraci&oacute;n - <span class="semi-bold">habitaci&oacute;n</span></h3>
                </div>	  
                <div class="row-fluid">
                    <div class="span12">
                        <div class="grid simple">
                            <div class="grid-title no-border">
                                <h4>Datos de <span class="semi-bold">Habitaci&oacute;n</span></h4>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span4">
                                            <div class="control-group">
                                                <label class="control-label">Tipo Habitaci&oacute;n: </label>
                                        ...
                                        <div class="span4">
                                            <div class="control-group">
                                                ...
                                                <span class="help">Numero de habitaci&oacute;n.</span>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="grid simple">
                            <div class="grid-title no-border">
                                <h4>Lista de <span class="semi-bold">Habitaciones</span></h4>
                                <div class="tools"> <a href="javascript:;" class="collapse"></a> </div>
                            </div>
                            <div class="grid-body ">
