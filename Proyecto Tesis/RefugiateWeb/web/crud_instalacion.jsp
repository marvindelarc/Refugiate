...
<!-- BEGIN HEADER -->
    ...
    <script type="text/javascript">
        ...
        {
            $.ajax({
                url: 'controles/instalacion/combo.jsp',
                type: 'POST',
                success: function (data) {
        ...
        function getTabla()
        {
            ...
            $.ajax({
                url: 'controles/instalacion/tabla.jsp',
                type: 'POST',
                success: function (data) {     
                         $('#tabla').html(data);
                },
        ...
        $(document).ready(function() 
        {
            ...
            $('#forml_validation').validate({
                ...
                messages: 
                {
                    cbServicio: "Seleccione Instalacion de la lista",
                    txtDetalle: "Ingrese detalles de la instalacion seleccionada"
                },
                ...
                {   
                    $("#myModal").modal('show');  
                    var url = "controles/instalacion/insert.jsp"; 
                    $.ajax({
                        type: "POST",
                        url: url,
        ...
        function edit_form(id,IdSucursal,cbServicio,txtDetalle,estado) {
            $('#Id').val(id);
            $('#IdSucursal').val(IdSucursal);
            $('#cbServicio').val(cbServicio);
            $('#txtDetalle').val(txtDetalle);
            if(estado==1)
