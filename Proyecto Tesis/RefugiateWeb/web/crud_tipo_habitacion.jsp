        ...
        <div id="container" class="page-content">
            ...
            <div class="content">
                ...
                <div class="page-title"> <i class="icon-custom-left"></i>
                    <h3>Configuraci&oacute;n - <span class="semi-bold">Tipo de Habitación</span></h3>
                </div>
                    ...
                    <div class="span12">
                        <div class="grid simple">
                            <div class="grid-title no-border">
                                <h4>Datos de <span class="semi-bold">Tipo de Habitaci&oacute;n</span></h4>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="grid simple">
                            <div class="grid-title no-border">
                                <h4>Lista <span class="semi-bold">Tipo de Habitaci&oacute;n</span></h4>
                                <div class="tools"> <a href="javascript:;" class="collapse"></a> </div>
                            </div>                  
                            <div class="grid-body ">
