...
public class DisponibilidadHTTP extends AsyncTask<Object, Integer, String>
{
    ...
    {
        int idCostoTipoHabitacion =(int) params[0];
        ...
        try {
            ...
            Value.add(new BasicNameValuePair("idCostoTipoHabitacion",""+idCostoTipoHabitacion));
